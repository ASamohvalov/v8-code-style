...
Идет проверка на неанглийские символы в имени web-сервиса и его параметров. Так же считается ошибкой использование подстроки "Service" в имени web-сервиса.
